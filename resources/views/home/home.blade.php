...
<body>
    <div style="font-family: 'Kanit', sans-serif;">
        ...
        <div class="box-hotel">
            <a href="{{url('/specialdeals/')}}"><img class="img-hotel" src="https://png.pngtree.com/thumb_back/fw800/background/20190903/pngtree-pink-sparkling-background-image_313710.jpg" alt="Snow">{{-- <img class="img-hotel" src="{{asset('assets/images/banner-book.png')}}" alt=""> --}}</a>
