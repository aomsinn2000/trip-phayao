...
<head>
    ...
    <!-- Title -->
    <title>แก้ไขหมวดหมู่สถานที่ท่องเที่ยว - {{ $touristAttractionCategory->name_th }}</title>
    ...
    <div class="page">
        ...
        <div class="main-content app-content px-5">
            <div class="container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            ...
                            <h5 class="content-title mb-0 my-auto" style="padding-bottom: 5px;">แก้ไขหมวดหมู่สถานที่ยอดฮิต - {{ $touristAttractionCategory->name_th }}</h5>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ url('/tourist-attraction-categories/save-update/' . $touristAttractionCategory->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-xl-7">
                        <div class="card card-body">
                            ...
                            <div class="row d-flex justify-content-between py-2">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="checkbox" data-on="เปิด" data-off="ปิด" data-toggle="toggle" data-size="sm" {{ $touristAttractionCategory->is_popular == 1 ? 'checked' : '' }} name="is_popular">
                                </div>
                                <div class="row-6 ">
                                    <label for="">สถานะ</label>
                                    <input type="checkbox" data-on="เปิดใช้งาน" data-off="ปิดใช้งาน" data-toggle="toggle" data-size="xs"{{ $touristAttractionCategory->is_status == 1 ? 'checked' : '' }} name="is_status">
                                </div>
                            </div>


                            <div class="">
                                <label>ชื่อหมวดหมู่สถานที่ (TH)</label>
                                <span id="showNumCateTh" style="float: right;">0/100</span>
                                <input type="text" class="form-control nameDealCateTh mb-2" onkeyup="inputNameCateTh(this)" placeholder="กรุณากรอกชื่อหมวดหมู่ภาษาไทย" value="{{ $touristAttractionCategory->name_th }}" name="name_th">
                                @error('name_th')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                <label class="my-2">ชื่อหมวดหมู่สถานที่ (EN)</label>
                                <span class="my-2" id="showNumCateEn" style="float: right;">0/100</span>
                                <input type="text" class="form-control nameDealCateEn" onkeyup="inputNameCateEn(this)" maxlength="100" placeholder="กรุณากรอกชื่อหมวดหมู่ภาษาอังกฤษ" value="{{ $touristAttractionCategory->name_en }}" name="name_en">
                                @error('name_en')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="card card-body">
                            ...
                            <div class="mb-4" style="width: 150px;">
                                <input type="file" class="input-upload-image" data-height="198" data-max-file-size="10M" data-allowed-file-extensions="JPG JPEG PNG jpg png jpeg"
                                    data-default-file="{{ $touristAttractionCategory->image ? asset('/storage/' . $touristAttractionCategory->image) : '' }}" name="image" />
                        ...
                        <div class="card card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" readonly id="user" value="{{ $touristAttractionCategory->creator }}">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <a href="{{ url('/tourist-attraction-categories/') }}" type="button" class="btn btn-secondary" style="width:150px; ">ยกเลิก</a>
                                    <span class="px-2">
                ...
                <div class="modal fade" id="trashAll" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <form action="{{ url('/tourist-attraction-categories/delete/' . $touristAttractionCategory->id) }}" method="POST">
                        @csrf
