    ...
    <div style="font-family: 'Kanit', sans-serif;">
        ...
        <div class="nav-background-placeHit">
            <p>
                ...
                <span><a href="{{ url('/touristattractioncategories/' . $category) }}" class="text-nav-placeHit"> {{ $category }} /</a></span>
                <span><a href="{{ url('/touristattractioncategories/' . $category . '/' . $ta) }}" class="text-nav-placeHit"> {{ $ta }} /</a></span>
                                ...
                                @foreach ($tag->touristAttractions as $attractions)
                                    <div class="list-item col-lg-3 col-md-6 mb-lg-3">
                                        <div class="card  text-white" style="border: none;">
                                            <a href="{{ url('/touristattractioncategories/' . $category . '/' . $attractions->name_th) }}"><img src="{{ $attractions->cover_image ? '/storage/' . $attractions->cover_image : asset('assets/image/unfound-image-b.jpg') }}" class="img-card-placeHit" alt="..."></a>
                                        ...
                                        <div class="padding-card-placeHit">
                                            <a href="{{ url('/touristattractioncategories/' . $category . '/' . $attractions->name_th) }}" type="button" class="btn btn-info text-white btn-map">ดูรายละเอียด</a>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
