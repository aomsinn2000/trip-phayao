...
<head>
    ...
    <!-- Title -->
    <title>เพิ่มหมวดหมู่สถานที่ท่องเที่ยว</title>
    ...
    <div class="page">
        ...
        <div class="main-content app-content px-5">
            <div class="container-fluid">
                ...
                <form action="{{ url('/tourist-attraction-categories/create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-xl-7">
                        <div class="card card-body">
                            ...
                            <div class="">
                                ...
                                <input type="text" class="form-control nameDealCateTh mb-2" id="" onkeyup="inputNameCateTh(this)" placeholder="กรุณากรอกชื่อหมวดหมู่ภาษาไทย" name="name_th" required>
                                @error('name_th')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                <label class="my-2">ชื่อหมวดหมู่สถานที่ (EN)</label>
                                <span class="my-2" id="showNumCateEn" style="float: right;">0/100</span>
                                <input type="text" class="form-control nameDealCateEn" id="" onkeyup="inputNameCateEn(this)" maxlength="100" placeholder="กรุณากรอกชื่อหมวดหมู่ภาษาอังกฤษ" name="name_en">
                                @error('name_en')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
