                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            ...
                            <a href="{{ url('/service-manages/') }}">
                                <h5 class="content-title mb-0 my-auto px-2" style="padding-top: 1px;">จัดการบริการเสริม ></h5>
                            </a>
                            <h5 class="content-title mb-0 my-auto " style="padding-bottom: 5px;">แก้ไขบริการเสริม</h5>
                        </div>
                    </div>
                </div>
                ...
                <form action="">
                    <div class="col-xl-7">
                        <div class="card card-body">
                            <div class="form-group row py-2">
                                <label for="idUser" class="col-sm-3 col-form-label">รหัสบริการเสริม</label>
                                <div class="col-sm-3">
                            ...
                            <div class="">
                                <label>ชื่อบริการเสริม (TH)</label>
                                ...
                                <label>ชื่อบริการเสริม (EN)</label>
                            ...
                            <div class="row my-2">
                                <div class="form-group col-6">
                                    <label for="category">หมวดหมู่บริการเสริม</label>
                    ...
                    <div class="card card-body">
                        <div class="row justify-content-end">
                            <a href="{{ url('/service-manages/') }}" type="button" class="btn btn-secondary" style="width:150px; ">ยกเลิก</a>
                            <span class="px-2">
