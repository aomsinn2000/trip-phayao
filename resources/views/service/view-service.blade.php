                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            ...
                            <h5 class="content-title mb-0 my-auto px-2" style="padding-bottom: 5px;">จัดการบริการเสริม</h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header" style="background-color: white;">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <h5><b>จัดการบริการเสริม</b></h5>
                                    </div>
                                    <div class="col-6">
                                        <a style="float: right; margin-right:35px;" href="{{ url('/service-manages/add') }}" type="button" class="btn btn-info">เพิ่มบริการเสริม</a>
                                    </div>
                                </div>
                                <div style="padding-top:60px;"></div>
                                <nav>
                                    <div class="nav main-nav-line" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" data-toggle="tab" href="#all-service" role="tab" aria-selected="true"><b>ทั้งหมด (100)</b></a>
                                        <a class="nav-item nav-link" data-toggle="tab" href="#on-service" role="tab" aria-selected="false"><b>เปิดการใช้งาน (50)</b></a>
                                        <a class="nav-item nav-link" data-toggle="tab" href="#off-service" role="tab" aria-selected="false"><b>ปิดการใช้งาน (50)</b></a>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    {{-- ทั้งหมด --}}
                                    <div class="tab-pane fade show active" id="all-service" role="tabpanel" aria-labelledby="all-specialDeal-tab">
                                        ...
                                        <table class="table table table-striped position-relative my-3" id="allService-table">
                                            ...
                                            <tbody style="text-align: center">
                                                <tr>
                                                    <td style="text-align: left;"><a href="{{ url('/service-manages/edit/{id}') }}" class="text-idSpecailDeal">DEAL64001</a></td>
                                    ...
                                    {{-- เปิดการใช้งาน --}}
                                    <div class="tab-pane fade" id="on-service" role="tabpanel" aria-labelledby="">
                                        <div class="row justify-content-center px-2 " style="background-color: #ECF0FA; height:70px;">
                                        ...
                                        <table class="table table table-striped position-relative my-3" id="onService-table">
                                            <thead class="thead-dark">
                                                <tr style="text-align: center;">
                                                    <th style="text-align: left;">รหัสสถานที่</th>
                                                    <th style="text-align: left;">ชื่อสถานที่ท่องเที่ยว</th>
                                    ...
                                    {{-- ปิดการใช้งาน --}}
                                    <div class="tab-pane fade" id="off-service" role="tabpanel" aria-labelledby="">
                                        <div class="row justify-content-center px-2 " style="background-color: #ECF0FA; height:70px;">
                                        ...
                                        <table class="table table-striped position-relative my-3 " id="offService-table">
                                            <thead class="thead-dark">
                                                <tr style="text-align: center;">
                                                    <th style="text-align: left;">รหัสสถานที่</th>
                                                    <th style="text-align: left;">ชื่อสถานที่ท่องเที่ยว</th>
 ...
 {{-- End Script ปฏิทิน --}}
    ...
    <script>
        $('a[data-toggle="tab"]').on("shown.bs.tab", function(e) {
            $('#allService-table').DataTable().columns.adjust();
        });
        $('a[data-toggle="tab"]').on("shown.bs.tab", function(e) {
            $('#onService-table').DataTable().columns.adjust();
        });
        $('a[data-toggle="tab"]').on("shown.bs.tab", function(e) {
            $('#offService-table').DataTable().columns.adjust();
        });
