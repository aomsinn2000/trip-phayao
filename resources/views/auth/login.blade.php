            ...
            <div class="form-login">
                ...
                <form>
                    ...
                    <div class="form-outline mb-2">
                      <input type="password" id="form2Example2" class="form-control input-password" required placeholder="กรุณากรอกรหัสผ่าน" name="fgf" />
                    </div>
                    ...
                    <div class="row mb-4">
                      <div class="col-7 d-flex justify-content-center">
                        ...
                        <div class="form-check">
                          <input class="form-check-input " type="checkbox" value="" required id="form2Example31" checked />
