...
<head>
    ...
    <link href="{{ asset('assets/css/deal/deal.css') }}" rel="stylesheet">
...
<body>
    ...
    <div style="font-family: 'Kanit', sans-serif;">
        ...
        <div class="naval-background-deal">
            <p>
                <a href="" class="text-nav-deal"> หน้าหลัก /</a>

                <span><a href="" class="text-nav-deal"> ดีลสุดพิเศษ /</a></span>
                    ...
                    <div class="col-10">
                        <div class="container ">
                            ...
                            <div class="row" style="font-size: 24px;">
                                ...
                                <div class="col-sm-6">
                                    <p class="float-end total-deal">จำนวนสิทธิคงเหลือ  <b> : 100 สิทธิ์</b></p>
                                </div>
                            </div>
                            ...
                            <p >
                                <span style="color: #E1473D; font-size:36px">
                                    <b> ราคาพิเศษ 3,999฿</b>
                                </span>
