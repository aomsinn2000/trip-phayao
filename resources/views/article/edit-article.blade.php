                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            ...
                            <a href="{{ url('/article-manages/') }}">
                                <h5 class="content-title mb-0 my-auto px-2" style="padding-top: 1px;">จัดการบทความ ></h5>
                            </a>
                            <h5 class="content-title mb-0 my-auto " style="padding-bottom: 5px;">แก้ไขบทความ</h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-7">
                        <div class="card card-body">
                            <div class="form-group row py-2">
                                <label for="idUser" class="col-sm-3 col-form-label">รหัสบทความ</label>
                                <div class="col-sm-3">
                            ...
                            <div class="">
                                <label>ชื่อบทความ (TH)</label>
                                <span id="showNumTh" style="float: right;">0/100</span>
                                <input type="text" class="form-control nameDealTh mb-2" id="" onkeyup="inputNameTh(this)" placeholder="กรุณากรอกชื่อบทความภาษาไทย">
                                <label>ชื่อบทความ (EN)</label>
                                <span id="showNumEn" style="float: right;">0/100</span>
                                <input type="text" class="form-control mb-2" id="" onkeyup="inputNameEn(this)" maxlength="100" placeholder="กรุณากรอกชื่อบทความภาษาอังกฤษ">
                            </div>
                            <div class="row my-2">
                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <a href="{{url('/article-manages/')}}" type="button" class="btn btn-secondary" style="width:150px; ">ยกเลิก</a>
                                    <span class="px-2">
