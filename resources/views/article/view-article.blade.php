...
<body class="main-body app sidebar-mini">
                    ...
                    <div class="my-auto">
                        <div class="d-flex">
                            <h5 class="content-title mb-0 my-auto">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" style="color: black; margin-bottom:5px;" width="20" height="20" fill="currentColor" class="bi bi-layout-text-sidebar-reverse" viewBox="0 0 16 16">
                                    <path d="M12.5 3a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1h5zm0 3a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1h5zm.5 3.5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 .5-.5zm-.5 2.5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1h5z" />
                                    <path d="M16 2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2zM4 1v14H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h2zm1 0h9a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5V1z" />
                                </svg>
                                บทความ >
                            </h5>
                            <h5 class="content-title mb-0 my-auto px-2" style="padding-bottom: 5px;">จัดการบทความ</h5>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header" style="background-color: white;">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <h5><b>จัดการบทความ</b></h5>
                                        </div>
                                        <div class="col-6">
                                            <a style="float: right; margin-right:35px;" href="{{ url('/article-manages/add') }}" type="button" class="btn btn-info">เพิ่มบทความ</a>
                                        </div>
                                    </div>
                                    <div style="padding-top:60px;"></div>
                                    <nav>
                                        <div class="nav main-nav-line" id="nav-tab" role="tablist">
                                            <a class="nav-item nav-link active" data-toggle="tab" href="#all-article" role="tab" aria-selected="true"><b>ทั้งหมด (100)</b></a>
                                            <a class="nav-item nav-link" data-toggle="tab" href="#on-article" role="tab" aria-selected="false"><b>เปิดการใช้งาน (50)</b></a>
                                            <a class="nav-item nav-link" data-toggle="tab" href="#off-article" role="tab" aria-selected="false"><b>ปิดการใช้งาน (50)</b></a>
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        {{-- ทั้งหมด --}}
                                        <div class="tab-pane fade show active" id="all-article" role="tabpanel" aria-labelledby="all-article-tab">
                                            ...
                                            <table class="table table table-striped position-relative my-3" id="allArticle-table">
                                                <thead class="thead-dark">
                                                    <tr style="text-align: center;">
                                                        <th style="text-align: left;">รหัสบทความ</th>
                                                        <th>วันที่เผยแพร่</th>
                                                        <th>ชื่อบทความ</th>
                                                ...
                                                <tbody style="text-align: center">
                                                    <tr>
                                                        <td style="text-align: left;"><a href="{{ url('/article-manages/edit/{id}') }}" class="text-id">NEW64001</a></td>
                                        ...
                                        {{-- เปิดการใช้งาน --}}
                                        <div class="tab-pane fade" id="on-article" role="tabpanel" aria-labelledby="">
                                            <div class="row justify-content-center px-2 " style="background-color: #ECF0FA; height:70px;">
                                            ...
                                            <table class="table table table-striped position-relative my-3" id="onArticle-table">
                                                <thead class="thead-dark">
                                                    <tr style="text-align: center;">
                                                        <th style="text-align: left;">รหัสบทความ</th>
                                                        <th>วันที่เผยแพร่</th>
                                        ...
                                        {{-- ปิดการใช้งาน --}}
                                        <div class="tab-pane fade" id="off-article" role="tabpanel" aria-labelledby="">
                                            <div class="row justify-content-center px-2 " style="background-color: #ECF0FA; height:70px;">
                                            ...
                                            <table class="table table-striped position-relative my-3 " id="offArticle-table">
                                                <thead class="thead-dark">
                                                    <tr style="text-align: center;">
                                                        <th style="text-align: left;">รหัสบทความ</th>
                                                        <th>วันที่เผยแพร่</th>
    ...
    <script>
        $('a[data-toggle="tab"]').on("shown.bs.tab", function(e) {
            $('#allArticle-table').DataTable().columns.adjust();
        });
        $('a[data-toggle="tab"]').on("shown.bs.tab", function(e) {
            $('#onArticle-table').DataTable().columns.adjust();
        });
        $('a[data-toggle="tab"]').on("shown.bs.tab", function(e) {
            $('#offArticle-table').DataTable().columns.adjust();
        });
    </script>
