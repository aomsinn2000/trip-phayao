                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            ...
                            <h5 class="content-title mb-0 my-auto px-2" style="padding-bottom: 5px;"> เพิ่มดีลพิเศษ</h5>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ url('/special-deals/create') }}" id="calculate" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-xl-7">
                        ...
                        <div class="card card-body">
                            ...
                            <textarea class="summernote" name="description_th">{{ old('description_th') }}</textarea>
                        </div>
                        <div class="card card-body">
                            <div class="row mb-3">
                                <div class="col-6">เงื่อนไขการใช้งาน</div>
                            </div>
                            <textarea class="summernote" name="condition_th">{{ old('condition_th') }}</textarea>
                        </div>
