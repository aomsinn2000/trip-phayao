    ...
    selectors.forEach((item, index) => {
        ...
        function multiSelects(){
            ...
            <div class="directorist-select__label">
                ...
                <input type="text" class='directorist-select__search ${ isSearch ? 'directorist-select__search--show' : 'directorist-select__search--hide' }' type='text' class='value' placeholder='เพิ่มแท็ก...' />
            </div>
